    ...
    internal class ModListMenu
    {
        ...
        internal void InitMenuCreation()
        {
            ...
            UIManager.EditMenus += () =>
            {
                                        ...
                                        {    
                                            if (
                                                !(
                                                    ...
                                                    (modInst.Mod is ICustomMenuMod customMenuMod && customMenuMod.ToggleButtonInsideMenu)
                                                )
                                            )
                                            {
                                        ...
                                        try 
                                        {
                                            ...
                                            c.AddMenuButton(
                                                ...
                                                new MenuButtonConfig
                                                {
                                                    ...
                                                    SubmitAction = _ => (UIManager.instance)
                ...
                var mbl = (MenuButtonList)optScreen.gameObject.GetComponent<MenuButtonList>();
        ...
        {
            ToggleMods();
            (UIManager.instance).UILeaveDynamicMenu(
        ...
        private MenuScreen CreateModMenu(ModInstance modInst, ModToggleDelegates? toggleDelegates)
        {
            ...
            if (toggleDelegates is ModToggleDelegates dels)
            {
        ...
        private void GoToModListMenu() => (UIManager.instance).UIGoToDynamicMenu(this.screen);
