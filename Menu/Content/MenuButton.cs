...
namespace Modding.Menu
{
    ...
    public static class MenuButtonContent
    {
        ...
        )
        {
            ...
            // MenuButton
            var menuButton = (MenuButton)option.AddComponent<MenuButton>();
            menuButton.buttonType = (MenuButton.MenuButtonType)MenuButton.MenuButtonType.CustomSubmit;
            menuButton.submitAction = config.SubmitAction;
            menuButton.cancelAction = (CancelAction)CancelAction.CustomCancelAction;
            menuButton.proceed = config.Proceed;
            ((MenuSelectable)(MenuSelectable)menuButton).customCancelAction = config.CancelAction;
