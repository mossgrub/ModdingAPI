...
namespace Modding.Menu
{
    ...
    public static class HorizontalOptionContent
    {
        ...
        )
        {
            ...
            menuOptionHorizontal.cancelAction = (CancelAction)CancelAction.CustomCancelAction;
            ((MenuSelectable)(MenuSelectable)menuOptionHorizontal).customCancelAction = config.CancelAction;
            content.NavGraph.AddNavigationNode(menuOptionHorizontal);
            // MenuSetting
            var menuSetting = (MenuSetting)option.AddComponent<MenuSetting>();
            menuSetting.settingType = (MenuSetting.MenuSettingType)MenuSetting.MenuSettingType.CustomSetting;
