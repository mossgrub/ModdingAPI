...
namespace Modding
{
    ...
    public class ModHooks
    {
        ...
        /// </summary>
        public static ReadOnlyDictionary<IMod, MenuScreen> BuiltModMenuScreens => new ReadOnlyDictionary<IMod, MenuScreen>(ModListMenu.ModScreens);

        /// <summary>
        ///     Dictionary of mods and their version #s
        /// </summary>
        public static readonly Dictionary<string, string> LoadedModsWithVersions = new Dictionary<string, string>();
